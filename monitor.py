...
max_cpu_percent = float(os.environ.get('MAX_CPU_PERCENT', 99.0))
max_mem_percent = float(os.environ.get('MAX_MEM_PERCENT', 99.0))
            ...
            if resource_monitor_enabled:
                ...
                if is_resource_critical:
                    ...
                    if downloading:
                        ...
                        logging.info(f"Pausing {len(hashes)} active torrent(s) to prevent OOM/CPU throttling. Manual resume required.")
