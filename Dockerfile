...
RUN apk update && \
    ...
    echo "Downloading qBittorrent version 5.1.3.10..." && \
    curl -L "https://github.com/c0re100/qBittorrent-Enhanced-Edition/releases/download/release-5.1.3.10/qbittorrent-enhanced-nox_x86_64-linux-musl_static.zip" -o /tmp/qbittorrent/qb.zip && \
